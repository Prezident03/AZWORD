...
const PATHS = {
  ...
  'book-marked': '<path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H19a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1H6.5a1 1 0 0 1 0-5H20"/><polyline points="10 2 10 10 13 7 16 10 16 2"/>',
  ...
  puzzle: '<path d="M19.439 7.85c-.049.322.059.648.289.878l1.568 1.568c.47.47.706 1.087.706 1.704s-.235 1.233-.706 1.704l-1.611 1.611a.98.98 0 0 1-.837.276c-.47-.07-.802-.48-.968-.925a2.501 2.501 0 1 0-3.214 3.214c-.446-.166-.855-.497-.925-.968a.979.979 0 0 1 .276-.837l1.61-1.61a2.404 2.404 0 0 0 0-3.404l-1.585-1.585a.98.98 0 0 1-.289-.878c.066-.352.298-.644.579-.825.776-.553 1.886-.502 2.731.118a.998.998 0 0 0 1.268 0c.845-.62 1.955-.67 2.731-.118.281.18.513.473.579.825"/><path d="m21.378 12.626-1.568-1.568a1.025 1.025 0 0 0-.878-.289c-.352.066-.644.298-.825.579-.553.776-.502 1.886.118 2.731a.998.998 0 0 1 0 1.268c-.62.845-.67 1.955-.118 2.731.18.281.473.513.825.579a1.025 1.025 0 0 0 .878-.289l1.568-1.568a2.404 2.404 0 0 0 0-3.404Z"/><path d="M9 8a2 2 0 0 1 2-2V6"/><path d="M15 8h2a2 2 0 1 1 0 4h-2"/><path d="M9 16v2a2 2 0 1 1-4 0v-2"/>',
  ...
  hand: '<path d="M18 11V6a2 2 0 0 0-2-2a2 2 0 0 0-2 2"/><path d="M14 10V4a2 2 0 0 0-2-2a2 2 0 0 0-2 2v2"/><path d="M10 10.5V6a2 2 0 0 0-2-2a2 2 0 0 0-2 2v8"/><path d="M18 8a2 2 0 1 1 4 0v6a8 8 0 0 1-8 8h-2c-2.8 0-4.5-.86-5.99-2.34l-1.42-1.42a2 2 0 0 1 2.83-2.83l.79.79"/>',
...
export const EMOJI_TO_ICON = {
  ...
  '🏅': 'medal', '🛒': 'shopping-bag', '📊': 'bar-chart',
  '👥': 'users', '🤖': 'bot', '📢': 'megaphone', '⚙️': 'settings',
  '🏠': 'home', '🚪': 'log-out', '📝': 'file-text', '🎉': 'party-popper',
  '💪': 'dumbbell', '🔤': 'languages', '🧩': 'puzzle', '🔗': 'link',
...
export function iconPickerHtml(selected = 'folder', inputId = 'folder-icon') {
  return `<div class="icon-picker" id="${inputId}-picker">
    ${FOLDER_ICONS.map(n => `
      <button type="button" class="icon-picker-btn${n === selected ? ' selected' : ''}"
        data-icon="${n}" onclick="selectIcon('${inputId}','${n}')">
        ${icon(n, { size: 22, color: 'var(--purple-light)' })}
      </button>`).join('')}
...
window.selectIcon = (inputId, name) => {
  ...
  document.querySelectorAll(`#${inputId}-picker .icon-picker-btn`).forEach(btn => {
